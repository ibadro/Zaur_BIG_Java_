...
public class Overloading {
    ...
    // можно создавать только один метод с одним именем и типом данных, но если добавить лишний параметр, то компилятор это пропустит
    // в случае с void show (int a, int b) , похоже на void show(int i1), если бы было одинаковое кол-во параметров, компилятор не пропустил бы
