...
/* Измините класс студент так, чтоы он имел 3 конструктора. 1-ый принимает все параметры. 2ой только ид, наме, сурнаме и курс. 3-ий
* не принимает значений. Создайте в классе СтудентТест 3 обьекта с помощью разных конструкторов. */
