...
package Java_Dlia_nashin.ТипыРеференсПеременныхИОбьектов23;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        Employee emp2 = new Hirurg();// референс переменная типа Employee может ссылать на объект типа Surgeon
