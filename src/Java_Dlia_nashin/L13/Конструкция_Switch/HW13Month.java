...
package Java_Dlia_nashin.L13.Конструкция_Switch;
/*В классе монс создайте метод, у которого 1 параметр типа данных инт. Этот параметр будет указывать порядковый номер месяца. Используя функционал свитч выведите
на экран количество дней этого месяца проверьте работу данного метода*/
