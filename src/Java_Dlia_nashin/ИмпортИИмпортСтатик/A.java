...
package Java_Dlia_nashin.ИмпортИИмпортСтатик;

import Java_Dlia_nashin.ПеременныеИПределыИхВидимости.Car; // испорт класса, вместо использования полного пути в паблик конструктору Java_shernii_poias.Lesson1.Lesson9.Car
import Java_Dlia_nashin.ПеременныеИПределыИхВидимости.Student; // испорт класса, вместо использования полного пути в паблик конструктору Java_shernii_poias.Lesson1.Lesson9.Student
