...
class Lesson5_1 {
    ...
    public static void main(String[] args) {
        ...
        // ВСЕГДА! name of contructor (new Java_shernii_poias.Lesson1.Lesson5()) = name of class (class Java_shernii_poias.Lesson1.Lesson5)
       
        int summaTrex = less5.summa(1, 2, 3); // (1, 2, 3) - аргументы метода summa объекта less5 класса Java_shernii_poias.Lesson1.Lesson5
    // System.out.println(summaTrex);
    // таким образом вызывается метод, он должен вызываться в методе мейн
    // следовательно мы создаем объект класса Java_shernii_poias.Lesson1.Lesson5, в котором
