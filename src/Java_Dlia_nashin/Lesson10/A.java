...
package Java_Dlia_nashin.Lesson10;

import Java_Dlia_nashin.Lesson9.Car; // испорт класса, вместо использования полного пути в паблик конструктору Java_shernii_poias.Lesson1.Lesson9.Car
import Java_Dlia_nashin.Lesson9.Student; // испорт класса, вместо использования полного пути в паблик конструктору Java_shernii_poias.Lesson1.Lesson9.Student
