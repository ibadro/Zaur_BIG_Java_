...
package Java_Dlia_nashin.L25.Полиморфизм;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        // в массив типа Employee я могу добавлять все рефренс типы данных, которые являются  детьми для Employee
...
// так сделать не могу, потому что класс абстрактный, то есть не может изменить объектов
