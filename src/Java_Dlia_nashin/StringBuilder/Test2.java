...
package Java_Dlia_nashin.StringBuilder;
...
public class Test2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sb1); // Java_shernii_poias.Lesson1.Lesson17.Car@7dc36524 - так выглядит визуализация объекта класса кар
